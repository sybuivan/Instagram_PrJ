...
import { BasicModal, ModalChooseItem } from '..';
...
const CreateNewPost = () => {
  ...
  } = useForm({ defaultValues: { contentCaption: '' } });
  //   show icon
  ...
  const handleOnShare = async (value) => {
    // call api share post
    console.log('value', value);
    const formData = new FormData();
    formData.append('contentCaption', value.contentCaption);
